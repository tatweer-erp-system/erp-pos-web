...
export function RefundModal({ open, onClose }: RefundModalProps) {
  ...
  const itemsTotal = foundOrder
    ? foundOrder.items.reduce(
        (s, i) => s + i.price * (selectedQtys[i.id] ?? 0),
        0
      )
    : 0;
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: 14 }}>
            ...
            <div
              style={{
                ...
                padding: "10px 14px",
                borderRadius: 10,
                background: `${token.colorError}06`,
                    ...
                    >
                      <Checkbox
                        ...
                        onChange={e => {
                          setSelectedQtys(prev => ({
                            ...prev,
                            [item.id]: e.target.checked ? item.qty : 0,
                          }));
                          setUseCustomAmt(false);
                        }}
                      />
            ...
            <div>
              <Checkbox
                ...
                onChange={e => {
                  ...
                  if (e.target.checked)
                    setCustomAmount(
                      itemsTotal > 0 ? itemsTotal : foundOrder.total
                    );
                }}
