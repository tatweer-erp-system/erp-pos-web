  ...
  return showImage ? (
    ...
    <div
      style={{
        ...
        transform:
          hovered && !outOfStock ? "scale(1.1) rotate(-4deg)" : "scale(1)",
        flexShrink: 0,
      }}
    >
  ...
  return (
    <div
      ...
      style={{
        ...
        boxShadow:
          hovered && !outOfStock
            ? `0 8px 24px ${token.colorPrimary}18, 0 2px 8px rgba(0,0,0,0.06)`
    ...
    >
      ...
      >
        ...
        {outOfStock && (
          ...
          >
            <StopOutlined
              style={{ color: "#fff", fontSize: 20, opacity: 0.7 }}
            />
          </div>
        )}
      </div>
      ...
      >
        ...
        <div
          style={{
            fontSize: 15,
            fontWeight: 800,
            color: outOfStock ? token.colorTextDisabled : token.colorPrimary,
            marginTop: "auto",
  ...
  return (
    <div
      ...
      style={{
        ...
        boxShadow:
          hovered && !outOfStock
            ? `0 4px 16px ${token.colorPrimary}18`
    ...
    >
      ...
      <div style={{ flex: 1, minWidth: 0 }}>
        ...
        <div style={{ marginTop: 3 }}>
          {outOfStock ? (
            <span
              style={{ fontSize: 10, color: token.colorError, fontWeight: 600 }}
            >
              {t.outOfStock}
            </span>
          ) : lowStock ? (
            <span style={{ fontSize: 10, color: "#F59E0B", fontWeight: 600 }}>
              {t.low}: {product.stock} {product.unit}
            </span>
          ) : (
...
export function ProductCard({ product, onAdd }: ProductCardProps) {
  ...
  if (posCardStyle === "compact")
    return <CompactStyle product={product} onAdd={onAdd} />;
  if (posCardStyle === "list")
    return <ListStyle product={product} onAdd={onAdd} />;
