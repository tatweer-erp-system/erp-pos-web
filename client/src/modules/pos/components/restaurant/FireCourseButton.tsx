...
export function FireCourseButton({ items }: FireCourseButtonProps) {
  ...
  const hasUnsent = Object.keys(groupedByCourse).some(
    id => courseStatuses[id] !== "sent"
  );
          ...
          >
            ...
            {status === "sent" && (
              <Button
                ...
                onClick={() =>
                  setCourseStatuses(prev => ({ ...prev, [courseId]: "ready" }))
                }
                style={{
                  fontSize: 11,
                  height: 28,
            ...
            {status === "ready" && (
              <Button
                ...
                icon={<CheckCircleOutlined />}
                onClick={() =>
                  setCourseStatuses(prev => ({ ...prev, [courseId]: "served" }))
                }
                style={{
                  fontSize: 11,
                  height: 28,
