...
export function SplitBillModal({
  ...
  function handleProcess() {
    message.success(
      `Bill split into ${ways} parts of $${amountPerPerson.toFixed(2)} each`
    );
    onClose();
  }
                ...
                >
                  ...
                  >
                    ...
                    <div style={{ flex: 1 }}>
                      ...
                      >
                        Split the total equally between guests
                      </div>
                    </div>
                    <InputNumber
                      min={2}
                ...
                >
                  ...
                  >
                    ...
                    <Select
                      ...
                      onChange={v => {
                        ...
                        setItemBills(
                          Object.fromEntries(
                            cartItems.map(i => [i.product.id, 1])
                          )
                        );
                      }}
                      style={{ width: 100 }}
                  ...
                  >
                    {cartItems.map(item => {
                      ...
                      const billColor =
                        BILL_COLORS[(billNum - 1) % BILL_COLORS.length];
                      return (
                        <div
                          key={item.product.id}
                          style={{
