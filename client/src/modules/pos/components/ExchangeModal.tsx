...
export function ExchangeModal({ open, onClose }: ExchangeModalProps) {
  ...
  function addNewItem() {
    ...
    setNewItems(prev => {
      ...
      if (existing) {
        return prev.map(i =>
          i.productId === selectedProductId ? { ...i, qty: i.qty + 1 } : i
        );
      }
      return [
        ...prev,
    ...
    >
      ...
      <div dir={isRTL ? "rtl" : "ltr"} style={{ padding: "20px 24px 24px" }}>
        ...
        {step === "select" && foundOrder && (
          <div style={{ display: "flex", flexDirection: "column", gap: 14 }}>
            ...
            >
              ...
              <Tag
                color={foundOrder.paymentMethod === "cash" ? "green" : "blue"}
              ...
              {foundOrder.items.map(item => (
                <div
                  ...
                  style={{
                    ...
                    borderRadius: 8,
                    marginBottom: 4,
                    background: returnedItemIds.has(item.id)
                      ? `${token.colorError}08`
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: 14 }}>
                  ...
                  >
                    ...
                    >
                      <Button
                        ...
                        icon={<MinusOutlined />}
                        onClick={() =>
                          updateNewItemQty(item.productId, item.qty - 1)
                        }
                        style={{
                          width: 26,
                          height: 26,
            ...
            >
              ...
              >
                {t.processExchange}
                {diff !== 0 &&
                  ` — ${diff > 0 ? "Collect" : "Credit"} $${Math.abs(diff).toFixed(2)}`}
              </Button>
            </div>
          </div>
        )}
        ...
        {step === "done" && foundOrder && (
          ...
          >
            <CheckCircleOutlined
              style={{ fontSize: 52, color: token.colorSuccess }}
            />
