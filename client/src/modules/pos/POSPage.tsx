...
function POSLayout() {
  ...
  useEffect(() => {
    if (!attachedTable?.seatedAt) {
      setSeatedDuration("");
      return;
    }
    const update = () =>
      setSeatedDuration(formatSeatedDuration(attachedTable.seatedAt!));
    update();
      ...
      >
          ...
          {restaurantMode.isRestaurant && isDineIn && attachedTable && (
            ...
            >
              ...
              {seatedDuration && (
                <>
                  <div
                    style={{ width: 1, height: 12, background: "#F59E0B30" }}
                  />
                  <span
                    style={{
                      display: "flex",
            ...
            {!isMobile && (
              <>
                  ...
                  restaurantMode.kitchenPrintingEnabled && (
                    <Tooltip title={t.sendToKitchen}>
                      <Button
                        ...
                        onClick={() => {
                          const kc =
                            document.getElementById("kitchen-ticket-btn");
                ...
                >
                  ...
                  <span>
                    {cashierSession ? cashierSession.cashierName : t.noCashier}
                  </span>
                </div>
                {cashierSession && (
                ...
                <Dropdown
                  ...
                  menu={{
                    items: [
                      {
                        key: "refund",
                        icon: <RollbackOutlined style={{ color: "#EF4444" }} />,
                        label: t.refund,
                        onClick: () => setRefundOpen(true),
                      },
                      {
        ...
        {isMobile && (
          ...
          >
            ...
            <div
              style={{ flex: 1, overflow: "hidden", padding: "0 12px 12px" }}
            >
